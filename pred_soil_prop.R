...
soil_prop_extended[, c(9:11, 13:ncol(soil_prop_extended))] = lapply(soil_prop_extended[, c(9:11, 13:ncol(soil_prop_extended))], FUN = function(y){as.numeric(y)})
summary(soil_prop_extended)
...
soil_prop2 <- cbind(soil_prop, (((soil_prop[,c(25,37,49,61,73,85,97,109,121)])-(soil_prop[,c(13,25,37,49,61,73,85,97,109)]))/2 + soil_prop[,c(13,25,37,49,61,73,85,97,109)])/10)
